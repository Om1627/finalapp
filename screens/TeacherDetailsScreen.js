...
export default class TeacherDetailsScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  updateRequestStatus = () => {
    ...
    db.collection("all_requests").add({
      ...
      requested_by: this.state.userId,
      requested_to: this.state.recieverName ,
  ...
  addNotification = () => {
    var message =
      this.state.userName + " has shown interest studying with you";
